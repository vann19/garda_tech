    ...
    <div className="relative z-10 w-full px-4 sm:px-8 lg:px-16 pb-24 bg-white">
      ...
      <div className="max-w-6xl mx-auto mb-12 text-center">
        <div className="section-title-wrapper inline-block">
          ...
          >
            <span className="shimmer-text">{t.shimmer} </span>
            <span className="text-gray-800">{t.rest}</span>
          </h2>
        </div>
          ...
          return (
            ...
            >
              ...
              <div className="p-4 flex flex-col gap-3 flex-1 bg-white">
                {/* Name & Role */}
                <div>
                  <p className="text-[10px] sm:text-xs text-gray-400 uppercase tracking-widest mb-0.5">{role}</p>
