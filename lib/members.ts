...
export const members: Member[] = [
  ...
  },
  {
    ...
    experienceEn: '1 Years Experience',
    photo: '/img/fan2.jpg',
    location: 'Yogyakarta, Indonesia',
    bio: 'Fullstack developer dengan pengalaman 1 tahun dalam membangun aplikasi web dan mobile. Berpengalaman dalam teknologi modern seperti Next.js, React Native, dan Node.js, dengan fokus pada performa dan pengalaman pengguna yang optimal.',
    bioEn: 'Fullstack developer with 1 years of experience in building web and mobile applications. Experienced in modern technologies such as Next.js, React Native, and Node.js, with a focus on performance and optimal user experience.',
    linkedin: 'https://www.linkedin.com/in/fansyalaode',
    experiences: [
      { company: 'Garda Tech', position: 'Fullstack Developer', positionEn: 'Fullstack Developer', period: '2025 - Sekarang' },
