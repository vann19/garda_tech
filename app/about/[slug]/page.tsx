...
export default function MemberBioPage({ params }: Props) {
  ...
  const t = lang === 'id' ? {
    ...
    collaborateDesc: 'Punya ide proyek luar biasa? Diskusikan kebutuhan bisnis Anda bersama kami dan tim ahli kami.',
    teamBtn: 'Kenali Anggota Tim Lain',
    notFound: 'Anggota tidak ditemukan',
    backLink: '← Kembali ke Tim',
  } : {
    about: 'About Me',
    experiences: 'Experiences',
    educations: 'Educations',
    collaborate: "Let's Collaborate",
    collaborateDesc: 'Have an amazing project idea? Discuss your business needs with us and our expert team.',
    teamBtn: 'Meet Other Team Members',
    notFound: 'Member not found',
    backLink: '← Back to Team',
  };
  ...
  // Pilih konten berdasarkan bahasa
  const role = lang === 'id' ? member.role : member.roleEn
  const specialty = lang === 'id' ? member.specialty : member.specialtyEn
  const experience = lang === 'id' ? member.experience : member.experienceEn
  const bio = lang === 'id' ? member.bio : member.bioEn
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-8 pt-20 pb-24">
        ...
        <div className="flex flex-col sm:flex-row gap-6 sm:gap-10 items-start sm:items-center mb-10">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-500 text-sm mt-1">{role} · {member.company}</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 flex flex-col gap-10">
            ...
            {/* About Me */}
            <section>
              <h2 className="text-lg font-bold font-['Syne'] mb-3 text-gray-900">{t.about}</h2>
              <p className="text-gray-500 text-sm sm:text-base leading-relaxed">{bio}</p>
            </section>

            {/* Experiences */}
            <section>
              <h2 className="text-lg font-bold font-['Syne'] mb-4 text-gray-900">{t.experiences}</h2>
            ...
            {/* Educations */}
            <section>
              <h2 className="text-lg font-bold font-['Syne'] mb-4 text-gray-900">{t.educations}</h2>
              <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="rounded-2xl bg-gradient-to-br from-violet-600 to-indigo-600 p-6 text-white shadow-lg shadow-violet-200">
              <p className="font-bold text-base font-['Syne'] mb-1">{t.collaborate}</p>
