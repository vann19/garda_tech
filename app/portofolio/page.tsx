...
export default function PortfolioPage() {
  ...
  const t = lang === 'id' ? {
    ...
    title1: 'Bukti di Setiap ',
    title2: 'Proyek.',
    subtitle: 'Setiap proyek adalah bukti komitmen kami terhadap kualitas, performa, dan kepuasan klien.',
    detailBtn: 'Lihat Detail',
    liveTitle: 'Lihat Live',
    ctaText: 'Punya proyek yang ingin dikerjakan bersama kami?',
    ctaBtn: 'Hubungi Kami',
  } : {
    badge: '✦ Our Portfolio',
    title1: 'Proof in Every ',
    title2: 'Project.',
    subtitle: 'Every project is proof of our commitment to quality, performance, and client satisfaction.',
    detailBtn: 'View Detail',
    liveTitle: 'View Live',
    ctaText: 'Have a project you want to work on with us?',
    ctaBtn: 'Contact Us',
  };
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 sm:pt-32 pb-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {projects.map((project) => {
            // 🔥 INI YANG PENTING: pilih konten berdasarkan bahasa
            const title = lang === 'id' ? project.title : project.titleEn
            const category = lang === 'id' ? project.category : project.categoryEn
            const description = lang === 'id' ? project.description : project.descriptionEn
            const tags = lang === 'id' ? project.tags : project.tagsEn
        ...
        <div className="mt-20 text-center">
          <p className="text-gray-500 text-sm mb-4">{t.ctaText}</p>
          <Link
            href="/contact"
